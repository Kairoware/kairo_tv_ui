              ...
              child: isLoading
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(padding: EdgeInsets.symmetric(horizontal: itemSpacing), child: AppIcon(app: app, onTap: () => DeviceApps.openApp(app.packageName), size: iconSize, borderWidth: borderWidth));
                      },
                    ),
            ),
          ],
